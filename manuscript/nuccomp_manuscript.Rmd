---
title: "nuccomp: a tool to rapidly summarize the contents of FASTA and FASTQ files containing nucleotides"
...
- New name: seqcomp (taken); seqcounter
- Add motif_counter?
- export to word?
...
The repository nuccomp contains a python script, an RMarkdown script, example data, and example output.
...
We present nuccomp as a suite of tools that utilizes the speed of python and Biopython [@cock2009biopython] with the graphics and RMarkdown [@allaire_etal2021] report generation of R [@R] to summarize the contents of FASTA files containing nucleotides.
...
The tool nuccomp provides an RMarkdown script to demonstrate these tasks and provides the user the option for customization.
...
Several currently-available software tools contain functions to output various summaries of fasta and fastq files, such as QUAST and SeqKit (refs).
