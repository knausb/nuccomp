...
knitr::kable(my_dat, caption = "**Table 1.** Existing software that describes FASTA/Q files.")
```
...
my_tab <- data.frame(
  ...
  Language = c("python", "python", "RMarkdown/R"),
  Purpose = c("Summarize whole sequences", 
              "Windowize sequences", 
              "Numeric and graphical presentation")
)
knitr::kable(my_tab, caption = "**Table 1.** Scripts included in nuccomp and their functionality.")
```
