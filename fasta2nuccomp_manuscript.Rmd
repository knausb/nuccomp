...
Our perspectives on what a genome has changed dramatically with our methods of assaying this unseeable phenomenon.
Our earliest perceptions may include X-ray crystallography [@franklin1953structure].
Cytogenetics brought the perspective of the karyogram to visualize chromosomes, their centromeres, and other features.
Short read genome sequencing presented us with genomes in FASTA files, text files containing nucleotides organized by chromosome.
