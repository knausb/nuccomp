...
These ttols consist of a python script that summarizes the FASTA file in a tabular format and an RMarkdown script that numerically and graphically summarize the tabular data.
...
Short read genome sequencing presented us with genomes in FASTA format files, text files in a specified format containing nucleotides organized by chromosome (or sequence), even if the number of sequences in these assemblies greatly outnumbered the expected number of chromosomes.
