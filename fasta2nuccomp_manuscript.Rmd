...
Current genome sequencing technology reports assays of this biochemical structure in a text file organized in the FASTA format.
Genomics projects therefore involve managing FASTA files.
Part of this management involves summarizing the contents of these large files in order to validated their contents as well as aid in organization.
And part of the management of these files involves collection of these summaries from the various workflow outputs.
This creates a situation where a significant amount of project time is invested in determining which summarries are available from which output and how to present this information.
